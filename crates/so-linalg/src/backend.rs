...
pub trait LinalgBackend: Send + Sync {
    ...
    fn cholesky(&self, _A: &Array2<f64>) -> Result<Array2<f64>> {
        Err(LinalgError::OperationFailed(
            "Cholesky not implemented".to_string(),
        ))
    }
...
impl LinalgBackend for NdarrayLinalgBackend {
    fn solve(&self, A: &Array2<f64>, b: &Array1<f64>) -> Result<Array1<f64>> {
        ...
        A.solve(b)
            .map_err(|e| LinalgError::OperationFailed(format!("Solve failed: {}", e)))
    }
    ...
    fn inv(&self, A: &Array2<f64>) -> Result<Array2<f64>> {
        ...
        A.inv()
            .map_err(|e| LinalgError::OperationFailed(format!("Inverse failed: {}", e)))
    }
...
impl LinalgBackend for PureRustBackend {
    fn solve(&self, A: &Array2<f64>, b: &Array1<f64>) -> Result<Array1<f64>> {
        ...
        Err(LinalgError::OperationFailed(
            "Pure Rust solver not yet implemented".to_string(),
        ))
    }
    ...
    fn inv(&self, A: &Array2<f64>) -> Result<Array2<f64>> {
        ...
        Err(LinalgError::OperationFailed(
            "Pure Rust inverse not yet implemented".to_string(),
        ))
    }
